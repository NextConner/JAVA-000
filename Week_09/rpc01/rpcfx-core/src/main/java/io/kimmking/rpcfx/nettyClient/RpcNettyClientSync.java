...
public class RpcNettyClientSync {
     ...
     */
    public RpcfxResponse getResponse(RpcfxRequest rpcRequest, String url) throws URISyntaxException, InterruptedException {
    ...
    private RpcProtocol convertNettyRequest(RpcfxRequest rpcRequest) {
