...
) ENGINE=InnoDB AUTO_INCREMENT=9223366075329572693 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `t_user_order` (
  ...
  `create_time` timestamp NULL DEFAULT '2020-11-30 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '订单创建时间',
  `update_time` timestamp NULL DEFAULT '2020-11-30 00:00:00' ON UPDATE CURRENT_TIMESTAMP COMMENT '订单更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=9079182131175074972 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC;
