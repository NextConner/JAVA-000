...
CREATE TABLE `t_order_detail`  (
  ...
  `create_time` timestamp(0) NULL DEFAULT '2000-01-01 00:00:00' COMMENT '创建时间',
  `update_time` timestamp(0) NULL DEFAULT '2000-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `t_user_order`  (
  ...
  `create_time` timestamp(0) NULL DEFAULT '2020-11-30 00:00:00' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '订单创建时间',
  `update_time` timestamp(0) NULL DEFAULT '2020-11-30 00:00:00' ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '订单更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 9223370676516064823 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
